...
const breakBootstrapTableHTML = `</div>
</div>
<div class="row">
...
const renderManager = manager => {
  ...
  template = handleRowBreaks (template);
  return template;
};
...
function handleRowBreaks (html) {
  console.log ("Here")
  employeeCount ++;
  if ((employeeCount % employeesPerRow == 0) && (employeeCount < totalEmployeeCount)) {
    html += breakBootstrapTableHTML;
